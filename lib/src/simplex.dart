...
final _perm = new List.generate(_p.length*2, (i) => _p[i % _p.length], growable: false);
final _permMod12 = new List.generate(_perm.length, (i) => _perm[i] % 12, growable: false);

// Skewing and unskewing factors for 2, 3, and 4 dimensions
final double _F2 = 0.5*(sqrt(3.0)-1.0);
final double _G2 = (3.0-sqrt(3.0))/6.0;
final double _F3 = 1.0/3.0;
final double _G3 = 1.0/6.0;
final double _F4 = (sqrt(5.0)-1.0)/4.0;
final double _G4 = (5.0-sqrt(5.0))/20.0;
...
double simplex2(double xin, double yin) {
  ...
  if(t0<0) n0 = 0.0;
    ...
    t0 *= t0;
    n0 = t0 * t0 * _dot2(_grad3[gi0], x0, y0);  // (x,y) of grad3 used for 2D gradient
  }
